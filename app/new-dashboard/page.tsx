...
const QUICK_ACTIONS: QuickAction[] = [
  ...
  {
    key: 'forum',
    title: 'Cộng đồng sĩ tử',
    description: 'Không gian hỏi đáp bài tập, trao đổi kinh nghiệm cùng bạn bè cả nước.',
    href: '/forum',
    tone: 'from-[#818CF8] via-[#6366F1] to-[#4F46E5]',
    icon: MessageSquare,
  },
  {
    key: 'messages',
    title: 'Sen Messages',
    description: 'Kênh thảo luận học tập và kết nối chuyên sâu với trợ lý học thuật.',
    href: '/mes',
