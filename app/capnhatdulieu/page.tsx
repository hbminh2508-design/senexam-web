...
// 🌟 ĐÂY LÀ DÒNG BẮT BUỘC PHẢI CÓ ĐỂ VERCEL BUILD ĐƯỢC (export default)
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mt-1 block">Merge tự động vào Database</span>
            </div>
          </div>
        </div>
